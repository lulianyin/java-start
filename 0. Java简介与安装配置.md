...
但不必拘泥于此: "语言一般只会定义其抽象语义，而不会强制性要求采用某种实现方式"
...
![image-20210713221559516](assets/image-20210713221559516.png)
